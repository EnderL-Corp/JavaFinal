...
public class CARD_TESTER_CLASS {
	...
	public static void mileStone1() {
		...
		System.out.println("" + troop2.getCurrentHealth() + " " + troop2.getCurrentAttack());
		// should return 11 12, as a dragon has 10 health and 10 attack + 1
		// health and + 2 attack makes 11 health and 12 attack

		troop2.modify(3, -4);

		System.out.println("" + troop2.getCurrentHealth() + " " + troop2.getCurrentAttack());
		// should return 10 10, as the dragon had 11 health and 12 attack + 3
		// health and - 4 attack makes 14 health and 8 attack
	}
	...
	public static void mileStone2() {
		...
		System.out.println(cardTesterClass.getCp());
		// a Dragon costs 15 cp, so player's cp would be at -8. Because of this,
		// the dragon should not place, and cp should remain at 7
		...
		System.out.println(cardTesterClass.getAp());
		// a Dragon costs 10 ap to move, so player's cp would be at -5. Because
		// of this, the dragon should not move, and ap should remain at 5

		cardTesterClass.remainingAp(10);
		cardTesterClass.remainingAp(Entity.move(troop2, cardTesterClass.getAp(), 4, 5));

		System.out.println(cardTesterClass.getAp());
		// a Dragon costs 10 ap to move, and i just gave the player 10 cp, so
		// player's cp would be at 0,
		// but because the dragon is trying to move into an occupied space the
		// dragon should not move, and ap should remain at 10
	...
	public static void mileStone3() {
		...
		System.out.println(Game.game.getEntityAt(2, 5) + "\t" + Game.game.getEntityAt(3, 5) + "\t"
				+ Game.game.getEntityAt(3, 6) + "\t" + Game.game.getEntityAt(3, 7) + "\t" + Game.game.getEntityAt(1, 6)
				+ "\t" + Game.game.getEntityAt(4, 4) + "\t" + Game.game.getEntityAt(3, 4));
		...
		System.out.println(Game.game.getEntityAt(2, 5) + "\t" + Game.game.getEntityAt(3, 5) + "\t"
				+ Game.game.getEntityAt(3, 6) + "\t" + Game.game.getEntityAt(3, 7) + "\t" + Game.game.getEntityAt(1, 6)
				+ "\t" + Game.game.getEntityAt(4, 4) + "\t" + Game.game.getEntityAt(3, 4));
		// should display the same thing, because the dragon cant attack the
		// drone due to the android's provoke
		...
		System.out.println(Game.game.getEntityAt(2, 5) + "\t" + Game.game.getEntityAt(3, 5) + "\t"
				+ Game.game.getEntityAt(3, 6) + "\t" + Game.game.getEntityAt(3, 7) + "\t" + Game.game.getEntityAt(1, 6)
				+ "\t" + Game.game.getEntityAt(4, 4) + "\t" + Game.game.getEntityAt(3, 4));
		// should display the same thing, except the android is replaced by
		// null, because it was killed by the dragon
		...
		System.out.println(Game.game.getEntityAt(2, 5) + "\t" + Game.game.getEntityAt(3, 5) + "\t"
				+ Game.game.getEntityAt(3, 6) + "\t" + Game.game.getEntityAt(3, 7) + "\t" + Game.game.getEntityAt(1, 6)
				+ "\t" + Game.game.getEntityAt(4, 4) + "\t" + Game.game.getEntityAt(3, 4));
		// should display Drone, null, null, null, Drone, null, dragon, because
		// the dragon's blast had nothing to provoke it, and could kill all thre
		// drones in one attack
		...
		System.out.println(Game.game.getEntityAt(2, 5) + "\t" + Game.game.getEntityAt(3, 5) + "\t"
				+ Game.game.getEntityAt(3, 6) + "\t" + Game.game.getEntityAt(3, 7) + "\t" + Game.game.getEntityAt(1, 6)
				+ "\t" + Game.game.getEntityAt(4, 4) + "\t" + Game.game.getEntityAt(3, 4));
		// should display the same as above, but first drone replaced with null,
		// because the dragon can attack diagonally is in melee range (with
		// regular attack, not blast attack)
		...
		System.out.println(Game.game.getEntityAt(2, 5) + "\t" + Game.game.getEntityAt(3, 5) + "\t"
				+ Game.game.getEntityAt(3, 6) + "\t" + Game.game.getEntityAt(3, 7) + "\t" + Game.game.getEntityAt(1, 6)
				+ "\t" + Game.game.getEntityAt(4, 4) + "\t" + Game.game.getEntityAt(3, 4));
		// should be the same as above, because the dragon cant attack
		// diagonally if out of range
		...
		System.out.println(Game.game.getEntityAt(2, 5) + "\t" + Game.game.getEntityAt(2, 7) + "\t"
				+ Game.game.getEntityAt(3, 6) + "\t" + Game.game.getEntityAt(3, 7) + "\t" + Game.game.getEntityAt(1, 6)
				+ "\t" + Game.game.getEntityAt(3, 4));
		...
		System.out.println(Game.game.getEntityAt(2, 5) + "\t" + Game.game.getEntityAt(2, 7) + "\t"
				+ Game.game.getEntityAt(3, 6) + "\t" + Game.game.getEntityAt(3, 7) + "\t" + Game.game.getEntityAt(1, 6)
				+ "\t" + Game.game.getEntityAt(3, 4));
		// should display the same thing as above, because the cyborg can't
		// attack with the android's provoke
		...
		System.out.println(Game.game.getEntityAt(2, 5) + "\t" + Game.game.getEntityAt(2, 7) + "\t"
				+ Game.game.getEntityAt(3, 6) + "\t" + Game.game.getEntityAt(3, 7) + "\t" + Game.game.getEntityAt(1, 6)
				+ "\t" + Game.game.getEntityAt(3, 4));
		// used the dragon to kill the provoke, and it also took out a drone. so
		// it should now display Drone, Cyborg, null, null, Drone, Dragon
		...
		System.out.println(Game.game.getEntityAt(2, 5) + "\t" + Game.game.getEntityAt(2, 7) + "\t"
				+ Game.game.getEntityAt(3, 6) + "\t" + Game.game.getEntityAt(3, 7) + "\t" + Game.game.getEntityAt(1, 6)
				+ "\t" + Game.game.getEntityAt(3, 4));
		// because the cyborg has range, it can attack and kill the drone,
		// making the display null, Cyborg, null, null, Drone, Dragon
		...
		System.out.println(Game.game.getEntityAt(2, 5) + "\t" + Game.game.getEntityAt(2, 7) + "\t"
				+ Game.game.getEntityAt(3, 6) + "\t" + Game.game.getEntityAt(3, 7) + "\t" + Game.game.getEntityAt(1, 6)
				+ "\t" + Game.game.getEntityAt(3, 4));
		// should display null, Cyborg, null, null, null, Dragon, because Dragon
		// and Cyborg are the only ones left
		...
		System.out.println(troop6.getCurrentHealth());
		// should snow return -7 (its dead), since the dragon does 10 damage to
		// its 3 health
		...
		System.out.println(troop6.getCurrentHealth());
		// Should return 3 health, because deflect should have negated the first
		// attack
		...
		System.out.println(troop6.getCurrentHealth());
		// should snow return -7 (its dead), since the dragon does 10 damage to
		// its 3 health, and deflect should only activate once (which it already
		// just did)

		troop3.addAbilities(4);

		System.out.println(
				drone2.getCurrentHealth() + "\t" + troop3.getCurrentHealth() + "\t" + troop2.getCurrentHealth());
		// should return 1 (health of drone), 7 (health of android), and 10,
		// health of dragon
		...
		System.out.println(
				drone2.getCurrentHealth() + "\t" + troop3.getCurrentHealth() + "\t" + troop2.getCurrentHealth());
		// should return -9, 3 (because the dragon's blast attacked both the
		// drone and the android), 5 (because the dragon's health is 10, and its
		// attack is 10 also.
		// When it attacks android, because android had mirror, the dragon
		// should take half its attack in damage (10 / 2 = 5), so it should take
		// 5 damage, and should have 5 health)
	}
	...
	public static void mileStone4() {
		...
		// should now display the same as above, because the actual method
		// returns the arrayList it had
