...
public interface GameServerInterface extends Remote, Serializable {
	 ...
	 * 
	 * @param gc
	 *            the GameClient to be connected
	 ...
	 * 
	 * @param gc
	 *            the invoking GameClient
	 * @param updated
	 *            updated 2d array of entities
	 * @return whether the value has been successfully updated or not. will not
	 *         successfully update if it is not your GameClient's turn.
	 * @throws RemoteException
	 */
	 ...
	 * 
	 * @param gc
	 *            the ClientInfo of the losing client
	 * @throws RemoteException
	 */
	 ...
	 * 
	 * @param newInfo
	 *            the updated version of the clientInfo
	 * @throws RemoteException
	 */
	 ...
	 * 
	 * @param thisClient
	 *            the client that wants the information
	...
	/**
	 * Gets the recent description of change that the other client made to
	 * board.
	 * 
	 ...
	 * 
	 * @param ci
	 *            the Client represented by ClientInfo to disconnect
	 * @throws RemoteException
	 */
